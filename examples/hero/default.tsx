...
export default function Example() {
    ...
    )} description='ShipIt turns repos, docs, tickets, and chat into a queryable graph — so on-call engineers stop asking the same question for the twelfth time.' actions={(
        <>
