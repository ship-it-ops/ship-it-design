...
export const Default: Story = {
  args: {
    eyebrow: <Badge variant="accent" dot>v2.0 · shipped today</Badge>,
    title: (
      <>
    ...
    actions: (
      <>
        <Button size="lg" variant="primary">Start free</Button>
        <Button size="lg" variant="secondary" trailing="→">Book a demo</Button>
      </>
    ),
  },
};
