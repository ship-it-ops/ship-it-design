...
const SERVICES = [
  {
    ...
    p99: 82,
    change: '2h ago',
    desc: 'Processes all customer-facing payment flows.',
  },
  {
    id: 'checkout-service',
    ...
    p99: 120,
    change: '12m ago',
    desc: 'Checkout funnel orchestration.',
  },
  {
    id: 'auth-svc',
    name: 'auth-svc',
    ...
    p99: 42,
    change: '1d ago',
    desc: 'Authentication + session issuance.',
  },
  {
    id: 'user-service',
    name: 'user-service',
    ...
    p99: 65,
    change: '3d ago',
    desc: 'User profiles + preferences.',
  },
  {
    id: 'billing-worker',
    name: 'billing-worker',
    ...
    p99: 210,
    change: '5d ago',
    desc: 'Async billing reconciliation.',
  },
  {
    id: 'notif-queue',
    name: 'notif-queue',
    ...
    p99: 95,
    change: '4h ago',
    desc: 'Durable queue for email + push.',
  },
  {
    id: 'search-svc',
    name: 'search-svc',
  ...
  },
  {
    ...
    p99: 0,
    change: '2d ago',
    desc: 'Internal shared utilities.',
  },
  {
    id: 'auth-lib',
    name: 'auth-lib',
    ...
    p99: 0,
    change: 'DEPRECATED',
    desc: 'Legacy auth SDK. Replaced by auth-svc SDK v2.',
  },
];
...
const CONNECTORS = [
  ...
  },
  {
    ...
    lastSync: '14m ago',
    rate: '8/min',
    note: 'Rate-limited 3x in last hour',
  },
  {
    id: 'backstage',
    name: 'Backstage',
...
const INCIDENTS = [
  {
    id: 'inc-482',
    sev: 'SEV-2',
    title: 'Elevated p99 on checkout flow',
    started: '8m',
    owner: 'payments-team',
  ...
  },
  {
    id: 'inc-481',
    sev: 'SEV-3',
    title: 'Datadog connector rate-limited',
    started: '14m',
    owner: 'platform-team',
    status: 'mitigated',
    services: ['datadog'],
...
const ACTIVITY = [
  ...
  { t: '21:31', k: 'DEPLOY', s: 'search-svc', m: 'v1.8.3 → production', c: 'ok' },
  {
    ...
    k: 'CLAIM',
    s: 'payments-api',
    m: 'owner: payments-team (github > backstage)',
    c: 'accent',
  },
