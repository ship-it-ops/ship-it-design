  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '6px 10px 16px' }}>
        ...
        <div style={{ fontSize: 10, color: t.textDim, marginLeft: 'auto', fontFamily: MONO }}>
          v2.4
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div
          style={{ width: 1, height: 14, background: t.border, marginLeft: 6, marginRight: 6 }}
        />
        <Btn small icon="⚙" ghost>
          Settings
        </Btn>
      </div>
    </div>
