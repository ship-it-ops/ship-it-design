...
function StepAsk() {
  ...
  return (
    <>
      ...
      <StepLede>
        Ask in plain words. Get answers with citations, not vibes. Every claim points back to the
        source that made it.
      </StepLede>
      ...
      >
        ...
        <span style={{ flex: 1, fontSize: 15, color: t.text, fontFamily: FONT }}>
          {typed}
          <span
            style={{ opacity: 0.7, animation: 'pulse 1.1s ease-in-out infinite', marginLeft: 1 }}
          >
            ▊
          </span>
        </span>
...
function StepAha() {
  ...
  const findings = [
    {
      sev: 'high',
      title: '3 tier-1 services have stale owners',
      sub: 'GitHub and Backstage disagree. Team "payments-legacy" was retired 6mo ago.',
      color: t.warn,
    },
    {
      sev: 'med',
      title: 'billing-worker still imports auth-lib v1.2',
      sub: 'Deprecated 17mo ago. Replacement: auth-lib v3 (active).',
      color: t.warn,
    },
    {
      sev: 'low',
      title: 'PagerDuty token expires in 4 days',
      sub: 'Re-auth before Nov 28 to keep sync alive.',
      color: t.textMuted,
    },
  ];
  return (
    <>
      ...
      <StepLede>
        We poked around while you weren't watching. Here's what we found. These won't page you —
        they'll just sit here until someone fixes them.
      </StepLede>
      ...
      {findings.map((f, i) => (
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 13, fontWeight: 500, color: t.text, marginBottom: 3 }}>
              {f.title}
            </div>
...
function StepInvite({ workspace }) {
  ...
  return (
    <>
      ...
      <StepLede>
        Owners fix their own claims. Everyone else can just ask. No seat math — pricing is
        usage-based.
      </StepLede>
      ...
      >
        {emails.map((e, i) => (
          ...
          >
            <span style={{ fontSize: 10, color: t.textDim, fontFamily: MONO, width: 18 }}>
...
function StepTour() {
  ...
  return (
    <>
      ...
      <StepHeadline>
        That's it. <span style={{ color: t.accent }}>Go look.</span>
      </StepHeadline>
      <StepLede>
        You have a graph, a team, and a very curious little AI. Press ⌘K from anywhere to start
        asking.
      </StepLede>
...
function StepJoin() {
  ...
  return (
    <>
      ...
      <StepHeadline>
        Maya added you to <span style={{ color: t.accent }}>acme</span>.
      </StepHeadline>
      <StepLede>
        Your graph is already built. 247 services, 3,890 claims. We just need to confirm who you are
        so we can wire you to your team.
      </StepLede>
      <div
        style={{
          background: t.panel2,
...
function StepTeam() {
  ...
  return (
    <>
      ...
      <StepHeadline>
        This is what <span style={{ color: t.accent }}>frontend-team</span> owns.
      </StepHeadline>
      <StepLede>
        Four services, one design system. We're tracking 18 claims on these — you can fix any of
        them with one click.
      </StepLede>
      <div
        style={{
          ...
          >
            ...
            <span
              style={{
                marginLeft: 'auto',
                fontSize: 11,
                color: status === 'healthy' ? t.textDim : t.warn,
              }}
            >
              {status}
            </span>
