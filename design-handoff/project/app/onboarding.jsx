        ...
        return (
          <React.Fragment key={s.k}>
            ...
            >
              ...
              <span
                style={{ fontSize: 11, color: active ? t.text : t.textMuted, fontFamily: MONO }}
              >
                {s.label}
              </span>
            </div>
  ...
  return (
    <div style={{ width: '100%', maxWidth: 560, margin: '40px auto 0' }}>
      ...
      <div style={{ color: t.textMuted, fontSize: 14, marginBottom: 28, maxWidth: 460 }}>
        This is the home for everyone at your company. You can invite teammates later — start with a
        name.
      </div>
  ...
  return (
    <div style={{ width: '100%', maxWidth: 680, margin: '40px auto 0' }}>
      ...
      <div style={{ color: t.textMuted, fontSize: 14, marginBottom: 28, maxWidth: 520 }}>
        ShipIt needs to see your repos to map services, ownership, and dependencies. Everything else
        builds on this.
      </div>
        ...
        <div style={{ padding: '22px 24px', display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 12, color: t.textMuted, marginTop: 3 }}>
              1,204 repositories · codeowners, dependency graph, workflows
            </div>
          </div>
  ...
  const opts = [
    {
      ...
      icon: '⎔',
      name: 'Kubernetes',
      desc: 'Live runtime mapping + deployments',
      count: '89 workloads',
    },
    {
      k: 'datadog',
    ...
    },
    {
      ...
      icon: '▨',
      name: 'Backstage',
      desc: 'Your existing service catalog',
      count: '247 entities',
    },
    {
      k: 'pagerduty',
  ...
  return (
    <div style={{ width: '100%', maxWidth: 820, margin: '40px auto 0' }}>
      ...
      <div style={{ color: t.textMuted, fontSize: 14, marginBottom: 28, maxWidth: 560 }}>
        Each connector adds PropertyClaims. When sources disagree, ShipIt picks the most
        authoritative one — and shows you why.
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10 }}>
        {opts.map((o) => {
          ...
          return (
            <div
              key={o.k}
              onClick={() => setSources({ ...sources, [o.k]: !on })}
              style={{
                background: t.panel,
      ...
      >
        ...
        <span>
          ...
          >
            browse all 14 connectors
          </span>{' '}
          — or connect later from the hub.
        </span>
      </div>
    </div>
  );
      ...
      >
        {[
          ...
          <Card key={l} pad={16}>
            ...
            <div style={{ fontSize: 30, fontFamily: MONO, fontWeight: 500, letterSpacing: -0.5 }}>
              {v.toLocaleString()}
            </div>
          </Card>
        ))}
        ...
        <Card pad={0} style={{ overflow: 'hidden', minHeight: 320 }}>
          ...
          >
            <SectionLabel style={{ marginBottom: 0 }}>
              live graph · {active.length} sources
            </SectionLabel>
            <div
              style={{
                marginLeft: 'auto',
          ...
          <div
            style={{
              height: 290,
              position: 'relative',
              background: `radial-gradient(ellipse at 50% 50%, ${t.panel2} 0%, ${t.panel} 70%)`,
            }}
          >
            ...
            {log.map((l, i) => (
              <div
                ...
                style={{
                  display: 'flex',
                  gap: 8,
                  color: i === log.length - 1 && !done ? t.text : t.textMuted,
                }}
              >
...
function StepAsk({ firstQ, setFirstQ }) {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 720, margin: '40px auto 0' }}>
      ...
      <div style={{ color: t.textMuted, fontSize: 14, marginBottom: 28, maxWidth: 520 }}>
        Natural language query across your new graph. Every answer shows its sources and which graph
        tools it called.
      </div>
      ...
      >
        ...
        <input
          ...
          onKeyDown={(e) => {
            if (e.key === 'Enter' && firstQ.trim()) setSubmitted(true);
          }}
        ...
        />
        <Btn small primary onClick={() => firstQ.trim() && setSubmitted(true)}>
          Ask
        </Btn>
      </div>
      ...
      {submitted && (
        <div className="fade-in">
          <Card
            style={{
              marginBottom: 10,
              background: `radial-gradient(circle at 85% 50%, ${t.accentGlow} 0%, transparent 55%), ${t.panel}`,
            }}
          >
            <SectionLabel>
            ...
            <div style={{ fontSize: 15, lineHeight: 1.55, marginBottom: 14 }}>
              You have <span style={{ color: t.accent }}>9 tier-1 services</span> in production.
              Three have stale owner fields where GitHub and Backstage disagree. I'd start with{' '}
              <MonoText style={{ color: t.accent }}>payments-api</MonoText> — it has 23 dependents
              and touches 3 customer flows.
            </div>
...
function StepInvite({ workspace }) {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 640, margin: '40px auto 0' }}>
      ...
      <div style={{ color: t.textMuted, fontSize: 14, marginBottom: 28, maxWidth: 520 }}>
        ShipIt is more useful when the people who know the services can fix their own claims. No
        seats, no credit card — invite who you like.
      </div>

      <Card style={{ marginBottom: 14 }}>
        <SectionLabel right={<span style={{ color: t.accent, cursor: 'pointer' }}>+ add row</span>}>
          Invite by email
        </SectionLabel>
        {emails.map((e, i) => (
          <div
      ...
      <Card>
        ...
        >
          ...
          <span style={{ marginLeft: 'auto', color: t.accent, cursor: 'pointer', fontSize: 10 }}>
            copy
          </span>
        </div>
        <div
