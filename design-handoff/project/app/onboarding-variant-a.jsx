    ...
    >
      ...
      >
        ...
        <div style={{ padding: '28px 32px 26px', minHeight: 320 }}>
          ...
          {cur === 'workspace' && (
            <ModalStepWorkspace workspace={workspace} setWorkspace={setWorkspace} />
          )}
...
function ModalStepConnect({ sources, setSources }) {
  ...
  return (
    <>
      <div style={{ fontSize: 26, fontWeight: 500, letterSpacing: -0.6, marginBottom: 6 }}>
        Connect your data.
      </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ paddingLeft: 14, color: t.textMuted }}>
          name, owner, tier, oncall, sla, runtime…
        </div>
        <div>
        ...
        <div style={{ color: t.textDim, marginTop: 6 }}>
          + 1,284 relationships across 12 edge types
        </div>
      </div>
    </>
  );
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 }}>
        {[
          ...
          >
            ...
            <div style={{ fontSize: 22, fontFamily: MONO, fontWeight: 500 }}>
              {v.toLocaleString()}
            </div>
          </div>
        ))}
  ...
  return (
    <>
      ...
      {[
        ...
        [
          'MED',
          '1 deprecated lib still used by billing-worker',
          'auth-lib v1.2 — 17mo old',
          t.warn,
        ],
...
function ModalStepJoin() {
  ...
  return (
    <>
      <div style={{ fontSize: 26, fontWeight: 500, letterSpacing: -0.6, marginBottom: 6 }}>
        Join <span style={{ color: t.accent }}>acme</span>.
      </div>
      <div style={{ color: t.textMuted, fontSize: 13, marginBottom: 22, maxWidth: 480 }}>
...
function ModalStepTeam() {
  ...
  return (
    <>
      <div style={{ fontSize: 22, fontWeight: 500, letterSpacing: -0.4, marginBottom: 6 }}>
        Here's what your team owns.
      </div>
      <div style={{ color: t.textMuted, fontSize: 13, marginBottom: 18 }}>
        frontend-team · 4 services in the graph
      </div>
      <div
        style={{
          background: t.panel2,
      ...
      >
        {['frontend-app', 'design-system', 'docs-site', 'marketing-site'].map((s, i) => (
          ...
          >
            ...
            <span style={{ marginLeft: 'auto', fontSize: 10, color: t.textDim, fontFamily: MONO }}>
              tier {i < 2 ? 1 : 2}
            </span>
          </div>
        ))}
