    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 22 }}>
          ...
          <div style={{ fontSize: 10, color: t.textDim, fontFamily: MONO, marginLeft: 'auto' }}>
            setup
          </div>
        </div>
        ...
        {STEPS.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              {active && (
                <span
                  style={{ marginLeft: 'auto', fontSize: 9, fontFamily: MONO, color: t.accent }}
                >
                  now
                </span>
              )}
        ...
        >
          ...
          >
            {cur === 'workspace' && (
              <div>
                <div
                  style={{ fontSize: 22, fontWeight: 500, letterSpacing: -0.5, marginBottom: 14 }}
                >
                ...
                >
                  ...
                  />
                  <span style={{ color: t.textDim, fontSize: 12, fontFamily: MONO }}>
                    .shipit.ai
                  </span>
                </div>
              </div>
            ...
            {cur === 'connect' && (
              <div>
                <div
                  style={{ fontSize: 20, fontWeight: 500, letterSpacing: -0.4, marginBottom: 4 }}
                >
                  Plug in your sources.
                </div>
                <div style={{ fontSize: 12, color: t.textMuted, marginBottom: 14 }}>
                  Each one adds nodes to the graph behind this panel.
                </div>
                {[
                  ['github', 'GitHub', '⌨'],
                  ['k8s', 'Kubernetes', '⎔'],
            ...
            {cur === 'schema' && (
              <div>
                ...
                <div style={{ fontSize: 12, color: t.textMuted, marginBottom: 14 }}>
                  Each source maps into the same schema. Conflicts get resolved with PropertyClaims.
                </div>
                <div style={{ fontFamily: MONO, fontSize: 11, lineHeight: 1.9 }}>
                  <div>
                    <span style={{ color: t.purple }}>LogicalService</span>{' '}
                    <span style={{ color: t.textDim }}>· 247</span>
                  </div>
                  <div>
                    <span style={{ color: t.purple }}>Repository</span>{' '}
                    <span style={{ color: t.textDim }}>· 1,204</span>
                  </div>
                  <div>
                    <span style={{ color: t.purple }}>Deployment</span>{' '}
                    <span style={{ color: t.textDim }}>· 89</span>
                  </div>
                  <div>
                    <span style={{ color: t.purple }}>Monitor</span>{' '}
                    <span style={{ color: t.textDim }}>· 340</span>
                  </div>
                </div>
              </div>
            )}
            {cur === 'sync' && (
              <div>
                <div
                  style={{ fontSize: 20, fontWeight: 500, letterSpacing: -0.4, marginBottom: 12 }}
                >
                ...
                >
                  <span>
                    <span style={{ color: t.accent }}>{Math.floor(pct * 2.47)}</span> services
                  </span>
                  <span>
                    <span style={{ color: t.accent }}>{Math.floor(pct * 12.84)}</span> edges
                  </span>
                  <span>
                    <span style={{ color: t.accent }}>{Math.floor(pct * 38.9)}</span> claims
                  </span>
                </div>
              </div>
            )}
            {cur === 'ask' && (
              <div>
                ...
                <div style={{ fontSize: 11, color: t.textDim, fontFamily: MONO }}>
                  ↩ try a starter, or write your own
                </div>
              </div>
            )}
            {cur === 'aha' && (
              <div>
                <div
                  style={{ fontSize: 18, fontWeight: 500, letterSpacing: -0.3, marginBottom: 12 }}
                >
            ...
            {cur === 'invite' && (
              <div>
                <div
                  style={{ fontSize: 20, fontWeight: 500, letterSpacing: -0.4, marginBottom: 14 }}
                >
                  Bring your team in.
                </div>
                {['', '', ''].map((_, i) => (
            ...
            {cur === 'tour' && (
              <div>
                <div
                  style={{ fontSize: 22, fontWeight: 500, letterSpacing: -0.5, marginBottom: 12 }}
                >
                  You're in. The rest is yours.
                </div>
                <div style={{ fontSize: 12, color: t.textMuted, marginBottom: 14 }}>
                  Hit ⌘K anywhere to ask. Press G to jump to the graph.
                </div>
              </div>
            )}
