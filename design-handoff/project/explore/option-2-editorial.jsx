    ...
    >
      ...
      <div
        style={{
          ...
          alignItems: 'center',
          padding: '14px 24px',
          borderBottom: `1px solid ${o2.border}`,
          gap: 28,
          background: o2.paper,
        }}
      >
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
          <div
            style={{ fontFamily: o2.serif, fontSize: 22, fontStyle: 'italic', letterSpacing: -0.5 }}
          >
            ShipIt
          </div>
          <div
        ...
        >
          ...
          <span
            style={{ marginLeft: 'auto', fontFamily: o2.mono, fontSize: 10, color: o2.textDim }}
          >
            ⌘K
          </span>
        </div>
        <div style={{ fontFamily: o2.mono, fontSize: 11, color: o2.textMuted }}>
          acme · platform
        </div>
      </div>
    ...
    <div style={{ flex: 1, padding: '36px 48px', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: 40, marginBottom: 36 }}>
        <div style={{ flex: 1 }}>
          ...
          >
            Your graph is
            <br />
            <span style={{ fontStyle: 'italic', color: o2.ink }}>breathing.</span>
          </div>
          <div style={{ fontSize: 14, color: o2.textMuted, maxWidth: 500, marginTop: 16 }}>
            247 services mapped across 7 sources. 3 connectors synced in the last hour. Two
            deployments rolling to production as we speak.
          </div>
        </div>
      ...
      >
        {[
          ...
          >
            <div style={{ fontFamily: o2.serif, fontSize: 48, letterSpacing: -1.5, lineHeight: 1 }}>
              {n}
            </div>
            <div
              style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.35fr 1fr', gap: 40 }}>
        ...
        <div>
          ...
          >
            <div style={{ fontFamily: o2.serif, fontSize: 24, letterSpacing: -0.3 }}>
              The dispatch
            </div>
            <div
              style={{
          ...
          {[
            {
              h: 'checkout-service rolled to production',
              b: 'v2.14.0 from main@a3f91c2. Owned by payments-team. Blast radius: 23 services.',
              t: '12 min',
              cat: 'DEPLOY',
            },
            {
              h: 'auth-lib marked deprecated',
              b: '4 downstream services still depend on it. Oldest dependency: billing-worker (17 months).',
              t: '3 hours',
              cat: 'SCHEMA',
            },
            {
              h: 'Datadog provenance: 4 conflicts resolved',
              b: 'PropertyClaim picked GitHub as winning source for owner field across 4 services.',
              t: '6 hours',
              cat: 'GRAPH',
            },
          ].map((x, i) => (
            ...
            >
              <div
                style={{ fontFamily: o2.mono, fontSize: 10, color: o2.accent, letterSpacing: 1.5 }}
              >
                {x.cat}
              </div>
              <div>
        ...
        <div>
              ...
              {['Who owns X?', 'Dependencies of Y', 'Services with stale docs'].map((q) => (
                <div
                  ...
                  style={{
                    padding: '4px 10px',
                    fontSize: 11,
                    border: `1px solid ${o2.borderStrong}`,
                    color: o2.textMuted,
                    fontFamily: o2.mono,
                  }}
                >
          ...
          <div
            style={{ fontFamily: o2.serif, fontSize: 20, letterSpacing: -0.2, marginBottom: 14 }}
          >
            Connectors
          </div>
          {[
            ...
            <div
              ...
              style={{
                ...
                gap: 12,
                padding: '10px 0',
                borderTop: i ? `1px solid ${o2.border}` : `1px solid ${o2.border}`,
              }}
            >
              <div style={{ fontSize: 13 }}>{n}</div>
              <div style={{ fontFamily: o2.mono, fontSize: 11, color: o2.textMuted, flex: 1 }}>
                {s}
              </div>
              <div
                style={{
                  fontFamily: o2.mono,
                  fontSize: 10,
                  color: st.includes('stale') ? o2.warn : o2.ok,
                  textTransform: 'uppercase',
                  letterSpacing: 1.2,
                }}
              >
  ...
  return (
    <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
      ...
      <div
        style={{
          width: 320,
          borderRight: `1px solid ${o2.border}`,
          background: o2.paper,
          padding: '28px 24px',
          overflow: 'hidden',
        }}
      >
        ...
        >
          Everything touching{' '}
          <span style={{ fontStyle: 'italic', color: o2.ink }}>payments-api</span> in production.
        </div>
        <div
          style={{
            background: o2.panel,
        ...
        {[
          ...
          >
            ...
            <div
              style={{ marginLeft: 'auto', fontFamily: o2.mono, fontSize: 11, color: o2.textDim }}
            >
              {n}
            </div>
          </div>
        ...
        {['Which deps are tier-1?', 'Who would I wake up at 3am?', 'What changed this week?'].map(
          (q, i) => (
            <div
              key={i}
              style={{
      ...
      <div style={{ flex: 1, position: 'relative', background: o2.bg, overflow: 'hidden' }}>
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: `radial-gradient(circle at 60% 40%, rgba(217,119,87,0.08), transparent 70%)`,
          }}
        />
        ...
        >
          ...
          >
            LogicalService · Tier 1
          </div>
          <div style={{ fontFamily: o2.serif, fontSize: 28, letterSpacing: -0.4, marginBottom: 4 }}>
            payments-api
          </div>
          <div style={{ fontSize: 12, color: o2.textMuted, marginBottom: 14 }}>
            Processes all customer-facing payment flows. Owned by payments-team. On call: Maya S.
          </div>
      ...
      {edges.map((e, i) => {
        ...
        return (
          <line
            ...
            x2={b.x}
            y2={rows[e[2]].y}
            stroke={focus ? o2.accent : o2.borderStrong}
          ...
          <g key={ri + '-' + ii}>
            {it.type === 'team' ? (
              <circle
                ...
                cy={row.y}
                r={it.focus ? 20 : 14}
                fill={it.focus ? o2.accent : typeColor[it.type]}
            ...
            <text
              ...
              fontSize="11"
              fontFamily={o2.mono}
              fill={it.focus ? o2.text : o2.textMuted}
              textAnchor="middle"
            >
              {it.label}
            </text>
