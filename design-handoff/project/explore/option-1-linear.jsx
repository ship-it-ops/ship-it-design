  ...
  return (
    ...
    >
      ...
      <div
        style={{
          width: 220,
          borderRight: `1px solid ${o1.border}`,
          padding: '16px 12px',
          display: 'flex',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 10px 18px' }}>
          ...
          <div style={{ fontSize: 10, color: o1.textDim, marginLeft: 'auto', fontFamily: o1.mono }}>
            v2.4
          </div>
        </div>
        ...
        <div
          style={{
            margin: '0 0 16px',
            padding: '8px 10px',
            background: o1.panel2,
            border: `1px solid ${o1.border}`,
            borderRadius: 6,
            display: 'flex',
            alignItems: 'center',
            gap: 8,
        ...
        >
          ...
          <span
            style={{ marginLeft: 'auto', fontFamily: o1.mono, fontSize: 10, color: o1.textDim }}
          >
            ⌘K
          </span>
        </div>
...
function O1Home() {
  return (
    <div style={{ padding: '24px 32px', overflow: 'hidden', flex: 1 }}>
      ...
      >
        <div>
          <div style={{ fontSize: 11, color: o1.textDim, fontFamily: o1.mono, marginBottom: 6 }}>
            acme / platform
          </div>
          <div style={{ fontSize: 28, fontWeight: 600, letterSpacing: -0.6 }}>
            Good evening, Mo.
          </div>
          <div style={{ color: o1.textMuted, marginTop: 4 }}>
            247 services, last indexed <span style={{ color: o1.text }}>4m ago</span>
          </div>
        </div>
      ...
      >
        ...
        >
          What's the blast radius if <span style={{ color: o1.accent }}>payments-api</span> goes
          down?
        </div>
        <div style={{ color: o1.textDim, fontSize: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginTop: 16, flexWrap: 'wrap' }}>
          {[
            ...
            'What broke in staging today?',
            'Services with stale docs',
      ...
      >
        {[
          ...
          >
            ...
            >
              {s.warn && (
                <span style={{ width: 6, height: 6, borderRadius: 999, background: o1.warn }} />
              )}
              {s.l}
            </div>
            <div
              style={{ fontSize: 28, fontWeight: 600, letterSpacing: -0.8, fontFamily: o1.mono }}
            >
              {s.n}
            </div>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                gap: 12,
                padding: '10px 0',
                borderTop: i ? `1px solid ${o1.border}` : 'none',
              }}
            >
        ...
        >
          ...
          {[
            ...
            >
              ...
              >
                <div
                  style={{ width: `${x.s}%`, height: '100%', background: x.warn ? o1.warn : o1.ok }}
                />
              </div>
              <div
                style={{
    ...
    <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
      ...
      >
        ...
        {[
          ...
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '7px 0' }}>
            ...
            <div
              style={{ marginLeft: 'auto', fontFamily: o1.mono, fontSize: 11, color: o1.textDim }}
            >
              {n}
            </div>
          </div>
        ...
        <div
          style={{
            ...
            borderRadius: 6,
            background: o1.panel2,
            border: `1px solid ${o1.borderStrong}`,
            fontSize: 12,
            fontFamily: o1.mono,
            display: 'flex',
            alignItems: 'center',
        ...
        <div style={{ fontSize: 11, color: o1.textMuted, padding: '8px 10px 0' }}>
          ...
          <div key={e} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '6px 0' }}>
            <div
              style={{
                ...
                border: `1px solid ${o1.borderStrong}`,
                borderRadius: 3,
                background: i === 0 ? o1.accent : 'transparent',
              }}
            />
      ...
      <div
        style={{
          flex: 1,
          position: 'relative',
          background: `radial-gradient(circle at 50% 40%, #141418 0%, ${o1.bg} 70%)`,
          overflow: 'hidden',
        }}
      >
        {/* Top toolbar */}
        ...
        >
          ...
          >
            <span style={{ color: o1.accent }}>✦</span>
            <span style={{ color: o1.text }}>
              show me everything that depends on payments-api in production
            </span>
          </div>
          <div
            style={{
        ...
        >
          <div style={{ fontSize: 11, color: o1.textDim, fontFamily: o1.mono, marginBottom: 4 }}>
            LogicalService
          </div>
          <div style={{ fontSize: 18, fontWeight: 600, letterSpacing: -0.3, marginBottom: 4 }}>
            payments-api
          </div>
          <div style={{ fontSize: 11, color: o1.textMuted, marginBottom: 14 }}>
            Tier 1 · payments-team
          </div>
          ...
          >
            ...
            <div style={{ fontSize: 11, color: o1.textDim, marginTop: 2 }}>
              Including 3 tier-1 customer flows
            </div>
          </div>
          <div
            style={{
          ...
          {['GitHub', 'Kubernetes', 'Datadog'].map((s) => (
            ...
            >
              ...
              <span style={{ marginLeft: 'auto', fontFamily: o1.mono, color: o1.textDim }}>
                fresh
              </span>
            </div>
          ))}
