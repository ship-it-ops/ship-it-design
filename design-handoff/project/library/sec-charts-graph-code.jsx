...
function SecCharts() {
  ...
  return (
    <Section
      id="charts"
      title="Charts (stylized)"
      desc="Graph-flavored visualizations. Minimal axes, thin strokes, accent for primary series, neutrals for context. Real dashboards stay restrained — one accent color carries the eye."
    >
          ...
          <Grid cols={4} gap={12} style={{ width: '100%' }}>
            {[
              ...
              { label: 'Avg latency', value: '94ms', spark: [...line].reverse(), color: T.ok },
              {
                label: 'Error rate',
                value: '0.2%',
                spark: line.map((v) => v * 0.3 + Math.random() * 2),
                color: T.warn,
              },
          ...
          >
            <Row style={{ marginBottom: 14 }}>
              <div>
                ...
                <div style={{ fontSize: 11, color: T.textDim, fontFamily: FM }}>
                  last 14 hours · 3 sources
                </div>
              </div>
              <Row gap={12} style={{ marginLeft: 'auto', fontSize: 11, color: T.textMuted }}>
                ...
                <Row gap={6}>
                  <div style={{ width: 10, height: 2, background: 'var(--purple)' }} />
                  <span>ask</span>
                </Row>
                <Row gap={6}>
                  <div style={{ width: 10, height: 2, background: T.textDim }} />
                  <span>search</span>
                </Row>
              </Row>
            </Row>
            <svg width="100%" height="160" viewBox="0 0 480 160" preserveAspectRatio="none">
              ...
              <polyline
                ...
                stroke={T.accent}
                strokeWidth="2"
                points="0,120 34,110 68,115 102,95 136,100 170,75 204,80 238,55 272,62 306,40 340,48 374,28 408,32 442,12 476,18"
              />
              <polyline
                fill="none"
                stroke="var(--purple)"
                strokeWidth="1.5"
                points="0,140 34,130 68,135 102,120 136,125 170,110 204,108 238,90 272,94 306,78 340,80 374,65 408,68 442,55 476,58"
              />
              <polyline
                fill="none"
                stroke={T.textDim}
                strokeWidth="1.5"
                strokeDasharray="3 3"
                points="0,150 34,148 68,152 102,145 136,142 170,140 204,138 238,132 272,130 306,125 340,123 374,118 408,115 442,110 476,108"
              />
            </svg>
            <Row style={{ marginTop: 8, fontSize: 10, color: T.textDim, fontFamily: FM }}>
              <span>9am</span>
              <span style={{ marginLeft: 'auto' }}>12pm</span>
              <span style={{ marginLeft: 'auto' }}>3pm</span>
              <span style={{ marginLeft: 'auto' }}>6pm</span>
                ...
                <Col key={i} gap={6} style={{ flex: 1, alignItems: 'center' }}>
                  <div
                    style={{
                      width: '100%',
                      height: `${b}%`,
                      background: i === 5 ? T.accent : T.panel2,
                      borderRadius: 3,
                      position: 'relative',
                    }}
                  >
                  ...
                  <span style={{ fontFamily: FM, fontSize: 10, color: T.textDim }}>
      ...
      <Subsection title="Donut">
        <Specimen>
          <Row gap={24} align="center">
            {[
              {
                label: 'Entity composition',
                data: [
                  ['Services', 42, T.accent],
                  ['People', 18, 'var(--purple)'],
                  ['Docs', 28, 'var(--pink)'],
                  ['Deploys', 12, T.ok],
                ],
              },
              ...
              return (
                ...
                >
                  <svg width="100" height="100" viewBox="0 0 100 100">
                    ...
                    <text x="50" y="62" textAnchor="middle" fontSize="9" fill={T.textDim}>
                      entities
                    </text>
                  </svg>
                  <Col gap={6}>
              ...
              {Array.from({ length: 7 * 12 }).map((_, i) => {
                ...
                const bg =
                  intensity < 0.2
                    ? T.panel2
                    : intensity < 0.4
                      ? 'oklch(0.5 0.08 200 / 0.3)'
                      : intensity < 0.65
                        ? 'oklch(0.65 0.1 200 / 0.55)'
                        : intensity < 0.85
                          ? 'oklch(0.75 0.12 200 / 0.8)'
                          : T.accent;
                return (
                  <div key={i} style={{ aspectRatio: '1 / 1', background: bg, borderRadius: 2 }} />
                );
              })}
            </div>
            <Row
...
function SecGraph() {
  return (
    <Section
      id="graph"
      title="Graph-specific"
      desc="Primitives for the core graph experience: nodes, edges, minimap, legend, inspector, path overlays."
    >
        ...
        <Specimen>
          <Row gap={18}>
            {[
              { s: 'default' },
              { s: 'hover', glow: 1.5 },
              { s: 'selected', ring: true },
              { s: 'path', ring: true, color: 'var(--purple)' },
              { s: 'dim', opacity: 0.35 },
            ].map((n, i) => (
              <Col key={i} gap={6} style={{ alignItems: 'center' }}>
                <div
                  style={{
                    ...
                    borderRadius: 14,
                    background: T.panel,
                    border: `1.5px solid ${n.color || T.accent}`,
        ...
        <Specimen pad={0} bg={T.bg}>
          <div
            style={{
              ...
              position: 'relative',
              background:
                'radial-gradient(circle at 50% 50%, oklch(0.18 0.02 260) 0%, oklch(0.12 0.01 260) 100%)',
              borderRadius: 8,
              overflow: 'hidden',
            }}
          >
            <svg width="100%" height="100%" viewBox="0 0 600 280">
              {Array.from({ length: 12 }).map((_, i) => {
                ...
                return (
                  <g key={i}>
                    <circle cx={x} cy={y} r="5" fill={T.accent} opacity="0.8" />
                  </g>
                );
              })}
            </svg>
            ...
            >
              ...
              <Col gap={4}>
                ...
                <Row gap={6}>
                  <div
                    style={{ width: 8, height: 8, borderRadius: 999, background: 'var(--purple)' }}
                  />
                  <span>person</span>
                </Row>
                <Row gap={6}>
                  <div
                    style={{ width: 8, height: 8, borderRadius: 999, background: 'var(--pink)' }}
                  />
                  <span>document</span>
                </Row>
              </Col>
        ...
        <Specimen>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: T.textMuted, marginBottom: 14 }}>
              Handles incoming Stripe webhook events, dedupes, forwards to ledger-core.
            </div>
            <div
              style={{
                fontFamily: FM,
            ...
            <Col gap={4} style={{ fontSize: 11 }}>
              {[
                ['→ depends on', 'ledger-core'],
                ['← called by', 'api-gateway'],
                ['owned by', 'Priya K.'],
                ['documented in', 'runbook-oncall.md'],
              ].map(([r, e], i) => (
                <Row key={i} gap={8}>
                  <span style={{ color: T.textDim, width: 100, fontFamily: FM }}>{r}</span>
                  <span>{e}</span>
                </Row>
              ))}
            </Col>
      ...
      <Subsection title="Path overlay">
        <Specimen pad={16}>
          ...
          >
            ...
            >
              4-hop path · webhook receipt → customer notification
            </div>
          </div>
        </Specimen>
      </Subsection>
...
function SecCode() {
  return (
    <Section
      id="code"
      title="Code, Diffs, Shortcuts"
      desc="Code specimens use Geist Mono with ordered line numbers. Inline code, blocks, diffs, and terminal outputs all share a muted panel background."
    >
      <Subsection title="Inline code">
        <Specimen>
          <div style={{ fontSize: 13, lineHeight: 1.7, maxWidth: 540 }}>
            Run <code style={inlineCode}>shipit sync github</code> to backfill. Configure retries
            with the <code style={inlineCode}>--retries</code> flag or set{' '}
            <code style={inlineCode}>SHIPIT_MAX_RETRIES</code> in your env.
          </div>
        </Specimen>
      </Subsection>
            ...
            {[
              {
                ...
                t: (
                  <>
                    ...
                    <span style={{ color: 'var(--purple)' }}>await</span> shipit.
              ...
              },
              {
                ...
                t: (
                  <>
                    {' '}
                    <span style={{ color: T.ok }}>match</span>:{' '}
                    <span style={{ color: T.warn }}>
                      '(s:Service)-[:DEPENDS_ON]-&gt;(d:Service)'
                    </span>
                    ,
                  </>
                ),
              },
              {
                ...
                t: (
                  <>
                    {' '}
                    <span style={{ color: T.ok }}>where</span>: {`{ s: { owner: `}
                    <span style={{ color: T.warn }}>'Payments'</span>
                    {` } }`},
                  </>
                ),
              },
              {
                ...
                t: (
                  <>
                    {' '}
                    <span style={{ color: T.ok }}>return</span>: [
                    <span style={{ color: T.warn }}>'s.name'</span>,{' '}
                    <span style={{ color: T.warn }}>'d.name'</span>],
                  </>
                ),
              },
              { ln: 5, t: <>{`});`}</> },
              { ln: 6, t: <></> },
              {
                ...
                t: (
                  <>
                    <span style={{ color: T.textDim }}>// 142 rows in 94ms</span>
                  </>
                ),
              },
            ].map((r) => (
        ...
        <Specimen pad={0}>
          ...
          >
            {[
              ...
              <div
                key={i}
                style={{ display: 'flex', padding: '0 16px', background: r.bg || 'transparent' }}
              >
                <span
                  style={{
                    color: T.textDim,
                ...
                <span style={{ width: 16, color: r.color || T.textDim, userSelect: 'none' }}>
                  {r.k}
                </span>
        ...
        <Specimen pad={0}>
          ...
          >
            ...
            >
              ...
              <span style={{ fontFamily: FM, fontSize: 11, color: T.textDim, marginLeft: 8 }}>
                ~/shipit · zsh
              </span>
            </Row>
            <div style={{ padding: 16, fontFamily: FM, fontSize: 12, lineHeight: 1.7 }}>
              <div>
                <span style={{ color: T.ok }}>$</span> shipit sync github --all
              </div>
              ...
              <div style={{ color: T.textMuted }}>
                {' '}
                shipit-api <span style={{ color: T.ok }}>✓</span> 2,841 files
              </div>
              <div style={{ color: T.textMuted }}>
                {' '}
                shipit-web <span style={{ color: T.ok }}>✓</span> 1,208 files
              </div>
              <div style={{ color: T.textMuted }}>
                {' '}
                shipit-ingest <span style={{ color: T.ok }}>✓</span> 482 files
              </div>
              <div style={{ color: T.textMuted }}>
                {' '}
                shipit-graph <span style={{ color: T.accent }}>⚙</span> ingesting ...
                <span
                  style={{
